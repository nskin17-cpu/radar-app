...
--
-- КОМУ ПРИХОДИТ: только администратору. Не клиенту — своего канала до клиента
--        у системы нет: уведомление говорит «пора позвонить», звонит человек.
--        И не менеджерам со складом — эти напоминания нужны руководителю,
--        остальных они бы только отвлекали.
--
